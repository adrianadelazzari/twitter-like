...
public class UserService {
    ...
    public UserEntity findByEmailAndPassword(String email, String password) throws TwitterLikeException {
        ...
        return this.userRepository.findByEmailAndPassword(email, password).orElseThrow(() -> new TwitterLikeException("user not found."));
    }

    public UserEntity findByUuid(String uuid) throws TwitterLikeException {
        return this.userRepository.findByUuid(uuid).orElseThrow(() -> new TwitterLikeException("user not found."));
    }

    public UserEntity findById(Integer userId) throws TwitterLikeException {

        return this.userRepository.findById(userId).orElseThrow(() -> new TwitterLikeException("user not found."));
    }
